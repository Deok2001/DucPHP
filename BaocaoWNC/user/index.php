	...
	<div class="well np">
		<div id="myCarousel" class="carousel slide homCar">
            <div class="carousel-inner">
			  <div class="item">
                <img style="width:100%;cursor: pointer;" src="../images/anhnen/830-300-830x300-13.png" alt="bootstrap ecommerce templates">
                <div class="carousel-caption">
                     
                </div>
              </div>
			  <div class="item">
                <img style="width:100%;cursor: pointer;" src="../images/anhnen/830-300-830x300-2.png" alt="bootstrap ecommerce templates">
                <div class="carousel-caption">
                      
                </div>
              </div>
			  <div class="item active">
                <img style="width:100%;cursor: pointer;" src="../images/anhnen/euro-oppo-830-300-830x300.png" alt="bootstrap ecommerce templates">
                <div class="carousel-caption">
                      
                </div>
              </div>
              <div class="item">
                <img style="width:100%;cursor: pointer;" src="../images/anhnen/banner.gif" alt="bootstrap templates">
                <div class="carousel-caption">
                     
                </div>
              </div>
			  <div class="item">
                <img style="width:100%;cursor: pointer;" src="../images/anhnen/slider-center.png" alt="bootstrap templates">
                <div class="carousel-caption">
		    ...
		    <form method="post">
			  <div class="thumbnail"> 
				...
				<div class="caption cntr">
					...
					<form>
				  		<button type="submit" class="shopBtn" name="themgiohang">Thêm giỏ hàng</button>
					</form>
					<br class="clr">
				</div>
			  </div>
